...
[
    ...
    new CustomButton(new MessageButton().setCustomId("x2").setLabel("Double Page").setStyle("SECONDARY"))
        //Doubles current page number. Because of zero-based number we are increasing by one before multiplying and decreasing by one.
        .setAction((pagination) => (pagination.currentPage + 1) * 2 - 1)
        //If array of number includes next page we should disable it.
        .setDisableWhen((pagination, nextPage) => [4, 5, 6, 7].includes(nextPage) ? nextPage : -1),
]
